...
\begin{itemize}
\item Ta gọi bài toán $(P)$ có nút ban đầu là $N_0$, tương ứng mỗi bài toán tối ưu tuyến tính thông thường $(P_i)$ ứng với mỗi nút $N_i$ trên sơ đồ nhánh và $\mathcal{L}$ là danh sách chứa các nút.
\item Ta đặt $z^*$ là giá trị tối ưu tốt nhất và $(x^*,y^*)$ là nghiệm tối ưu tốt nhất của bài toán được đánh dấu.
\end{itemize}
\end{frame}

\begin{frame}
\textbf{Bước 1. Thiết lập} Đặt $\mathcal{L}:=\{N_0 \}$, $z^*=z_p$ và $(x^*,y^*)=(x,y)$.
